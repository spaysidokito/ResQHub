    ...
    return (
        <AdminSidebarLayout>
            <div className="flex justify-between items-center mb-8">
                ...
                <Button variant="default" className="bg-black text-white border border-neutral-800 hover:bg-neutral-900">create item</Button>
            </div>
            <Card className="p-6 rounded-xl border border-neutral-800 bg-black max-w-4xl mx-auto">
                <table className="w-full text-left border-collapse bg-black text-white">
                    ...
                    <tbody>
                        {items.map((item) => (
                            <tr key={item.id} className="border-b border-neutral-800 last:border-b-0 hover:bg-neutral-900">
